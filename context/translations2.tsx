...
export const tProyectos = {
  es: {
    ...
    labels:{ problem:"El problema", solution:"La solucion", architecture:"Arquitectura", result:"Resultado" },
    items:[
      { tag:"Automatizacion Financiera", title:"Pipeline de procesamiento automatico de facturas",
        ...
        diagram:"[SharePoint/Inbox]  ->  [Power Automate]  ->  [Dataverse]\n                         - AI Builder (OCR)\n                         - Claude API (extract)\n                         - Try / Catch fallback",
      ...
      { tag:"Atencion al Cliente", title:"Bot de soporte inteligente via WhatsApp",
        ...
        diagram:"[WhatsApp / Meta API]  ->  [n8n + LLM]  ->  [Chatwoot]\n                             - Intent classification\n                             - Natural-language reply\n                             - Escalation to human",
      ...
      { tag:"Infraestructura", title:"Stack de automatizacion self-hosted en VPS",
        ...
        diagram:"[Cloudflare DNS/SSL]  ->  [VPS + Easypanel]\n                              - n8n\n                              - Chatwoot\n                              - Paperclip AI\n                              - PostgreSQL",
      ...
      { tag:"Gestion Interna", title:"Sistema de ordenes de compra y proveedores",
        ...
        diagram:"[Next.js + TypeScript]  ->  [Supabase + shadcn/ui]\n                                - Auth / RLS\n                                - Purchase orders\n                                - Supplier management\n                                - Payment approval flow",
  ...
  en: {
    ...
    labels:{ problem:"The problem", solution:"The solution", architecture:"Architecture", result:"Result" },
    items:[
